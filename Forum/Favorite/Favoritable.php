...
{
    /**
     * Check if the authenticated user has favorited the topic.
    ...
    /**
     * Get the favorites count of the topic.
     *
     * @return integer
     */
    ...
    /**
     * Get the users that favorited the topic.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
    public function favorited()
    {
        return $this->belongsToMany(User::class, 'favorites', 'topic_id', 'user_id')->withTimestamps();
    }

    /**
     * Check if the topic is favorited by the given user.
     *
     * @param User $user
     * @return bool
     */
